        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-2">
          {services.map((sv) => {
            ...
            return (
              <div
                key={sv.title}
                className="group flex flex-col rounded-card border border-line bg-white p-7 transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_28px_70px_-40px_rgba(42,21,56,0.55)] sm:p-8"
              >
                ...
                <Link
                  href={sv.href}
                  className="mt-5 inline-flex items-center gap-1.5 text-sm font-semibold text-purple transition-colors hover:text-magenta"
                >
                  {sv.cta}
